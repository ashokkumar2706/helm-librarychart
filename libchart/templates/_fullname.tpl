...
Usage: 'name: "{{- template "libchart.fullname" . -}}"'
*/ -}}
...
{{- /*
libchart.fullname.unique adds a random suffix to the unique name.

This takes the same parameters as libchart.fullname

*/ -}}
{{- define "libchart.fullname.unique" -}}
  {{ template "libchart.fullname" . }}-{{ randAlphaNum 7 | lower }}
{{- end }}
